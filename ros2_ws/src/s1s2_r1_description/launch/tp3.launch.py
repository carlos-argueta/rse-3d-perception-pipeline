...
def generate_launch_description():
    ...
    xacro_file = os.path.join(get_package_share_directory('s1s2_r1_description'), 'urdf', 'tutorial_part3.urdf.xacro')
    ...
    rviz2 = Node(
        ...
        name='rviz2',
        output='screen',
        arguments=['-d', PathJoinSubstitution([FindPackageShare("s1s2_r1_description"), 'rviz', "display.rviz"]),],
